...
paper. Disagreement localises itself — `--pin-all` pins every round, and the
round where the solver first refuses is the round to look at.
...
`python3 diggui.py` serves a page on `127.0.0.1:8765`. Digital is already the
